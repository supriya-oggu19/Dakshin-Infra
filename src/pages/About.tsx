...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="pt-20 pb-12 space-y-16 md:space-y-20">
        {/* Hero Section */}
        <section className="pt-12 md:pt-20 px-4">
          <div className="max-w-4xl mx-auto text-center px-2">
            <Badge className="mb-4 bg-primary/20 text-primary border-primary/30 text-sm md:text-base">
              About Ramya Constructions
            </Badge>
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 md:mb-6 leading-snug glow-text">
              Your Trusted Partner in{" "}
              <span className="text-primary block">Commercial Real Estate</span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Ramya Constructions Ltd., incorporated on 17th December 1992, is a
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {stats.map((stat, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="card-luxury text-center p-8 animate-fade-in"
                    style={{ animationDelay: `${index * 200}ms` }}
                  >
                    <div className="w-16 h-16 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center mx-auto mb-5">
                      <Icon className="w-8 h-8 text-primary-foreground" />
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold text-primary glow-text mb-1">
                      {stat.value}
                    </h3>
        ...
        <section className="py-12 md:py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              <Badge className="mb-3 bg-primary/20 text-primary border-primary/30 text-sm md:text-base">
                Our Story
              </Badge>
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 glow-text leading-snug">
                Building Dreams, Creating Wealth
              </h2>
            </div>

            <div className="card-luxury p-6 sm:p-8 md:p-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-muted-foreground text-base sm:text-lg leading-relaxed mb-5">
                  Ramya Constructions Ltd., incorporated on 17th December 1992,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {values.map((value, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="card-luxury p-6 sm:p-8 text-center animate-fade-in"
                    style={{ animationDelay: `${index * 200}ms` }}
                  >
                    <div className="w-16 h-16 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center mx-auto mb-5">
                      <Icon className="w-8 h-8 text-primary-foreground" />
        ...
        <section className="py-12 md:py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card-luxury p-6 sm:p-8 md:p-12">
              <blockquote className="text-base sm:text-lg md:text-xl text-muted-foreground italic leading-relaxed text-center">
