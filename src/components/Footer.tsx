...
const Footer = () => {
  ...
  const openRefund = () => setIsRefundOpen(true);
  const closeRefund = () => setIsRefundOpen(false);
  ...
  const legalLinks = [
    { name: "Privacy Policy", action: openPrivacy },
    { name: "Terms & Conditions", action: openTerms },
    { name: "Refund Policy", action: openRefund },
                ...
                {legalLinks.map((l, i) => (
                  <li key={i}>
                    {l.action ? (
                      <button
                        onClick={l.action}
                        className="text-left hover:text-yellow-600 transition-colors cursor-pointer w-full text-left"
                      >
                        {l.name}
                      </button>
                    ) : (
